                ...
                <div class="modal-content">
                    ...
                    <form action="" method="post" id="promocion_form" enctype="multipart/form-data">
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <input name="id" value="{{$promocion->id}}" hidden>
                                @if (Auth()->user()->rol == 2)
                                ...
                                @else
                                    <div class="form-group col-md-6">
                                        ...
                                        <select id="" name="locale_id" class="form-select" readonly=tru>
                                            <option value="">seleccione</option>
                                            @foreach ($locales as $item)
                                                <option value="{{ $item->id }}" {{ ( $item->id == $local->id) ? 'selected' : '' }}>{{ $item->titulo }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    <label for="titulo"></label>
                                    <input name="titulo" type="text" class="form-control" id="titulo" value="{{$promocion->titulo}}"
                                        placeholder="Titulo">
                                    @error('titulo')
                                        <span class="error text-danger">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input name="fechaini" type="date" class="form-control" id="fechaini" value="{{$promocion->fechaini}}"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input name="fechafin" type="date" class="form-control" id="fechafin" value="{{$promocion->fechafin}}"
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input name="lclfechaini" type="date" class="form-control" id="lclfechaini" value="{{$promocion->lclfechaini}}"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input name="lclfechafin" type="date" class="form-control" id="lclfechafin" value="{{$promocion->lclfechafin}}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-control custom-radio">
                                    <input class="custom-control-input" type="radio" id="customRadio3" name="estado" {{ 1 == old('estado', $promocion->estado) ? 'checked' : '' }}
                                        value="1" required>
                                    <label for="customRadio3" class="custom-control-label">Activo</label>
                                </div>
                                <div class="custom-control custom-radio">
                                    <input class="custom-control-input" type="radio" id="customRadio4" name="estado" {{ 0 == old('estado', $promocion->estado) ? 'checked' : '' }}
                                        value="0" required>
                        ...
                        <div class="modal-footer">
                            ...
                            <input type="submit" value="Actualizar" class="btn btn-warning float-right">
                        </div>
                    </form>
                </div>
