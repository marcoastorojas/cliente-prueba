                    ...
                    <table role="presentation"
                        ...
                        <tr>
                            <td style="padding:40px 30px 30px 30px;text-align:center;font-size:24px;font-weight:bold;">
                                <a href="https://clientevip.pe/" style="text-decoration:none;"><img
                                        src="https://clientevip.pe/back/assets/img/logo-cv3.png"
                                        width="165" alt="Logo"
                        ...
                        <tr>
                            <td style="padding:30px;background-color:#ffffff;">
                                ...
                                @if ($msg['tipo'] == 'C')
                                    <p style="text-align: center;"> <h3 style="text-align: center;"><b>¡FELICITACIONES! por recibir tu Recompensa.</b></h3> </p>
                                @endif
                                ...
                                @if ($msg['tipo'] == 'A')
                                    <p>Revisa tus puntos actuales y recompensas en cualquier momento. Ingresa a <a
                                            href="https://clientevip.pe" target="../">www.clientevip.pe</a></p>
                                    <p>Gracias por ser parte de <a href="https://clientevip.pe/">ClienteVIP</a>.</p>
                                @else
                                    <p>Sigue acumulando puntos y recibe más recompensas con Cliente VIP de tus negocios
                                        favoritos.
                                        Revisa tus puntos en <a href="https://clientevip.pe"
                                            target="../">clientevip.pe</a></p>
