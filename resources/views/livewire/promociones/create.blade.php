    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input wire:model="locale_id" type="text" class="form-control" id="locale_id" placeholder="Locale Id">@error('locale_id') <span class="error text-danger">{{ $message }}</span> @enderror
            </div> --}}
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <input wire:model.defer="file" type="file" class="form-control" id="file"
                                placeholder="File">
                            @error('file')
                                <span class="error text-danger">{{ $message }}</span>
                            @enderror
