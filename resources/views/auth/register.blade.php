...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <section class="min-vh-100 mb-8">
        {{-- <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg"
            style="background-image: url({{ asset('back/assets/img/curved-images/curved14.jpg') }});"> --}}
        <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg">
            ...
            {{-- <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 text-center mx-auto">
                        ...
                        <p class="text-lead text-white">Para acumular puntos en los comercios, regístrate.</p>
                    </div>
                </div>
            </div> --}}
        </div>
                    ...
                    <div class="card z-index-0">
                        <div class="row justify-content-center">
                            <div class="col-lg-12 text-center mx-auto">
                                ...
                                <p class="text-lead text-black">Para acumular puntos en negocios afiliados, regístrate.</p>
                            </div>
                        </div>
                            ...
                            <form role="form text-left" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="mb-3">
                                    <input type="text" class="form-control" placeholder="Apellidos"
                                        aria-label="apellidos" @error('apellidos') is-invalid @enderror"
                                ...
                                <div class="mb-3">
                                    <input type="number" class="form-control" placeholder="DNI o RUT" aria-label="Dni"
                                        oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                        maxlength="8" class="form-control @error('dni') is-invalid @enderror" name="dni"
                                        value="{{ old('dni') }}" maxlength="8" required autocomplete="dni" autofocus
                                        minlength="8">
                                ...
                                <div class="mb-3">
                                    <input type="email" class="form-control" placeholder="Email" aria-label="Email"
                                        aria-describedby="email-addon" @error('email') is-invalid @enderror"
                                ...
                                <div class="mb-3">
                                    <input type="password" class="form-control" placeholder="Nueva Contraseña para ClienteVip"
                                        aria-label="Password" @error('password') is-invalid @enderror" name="password"
                                ...
                                <div class="mb-3">
                                    <input type="text" class="form-control" placeholder="Código promocional (opcional)" aria-label="Cupón"
                                        @error('cupon') is-invalid @enderror name="cupon" value="{{ old('cupon') }}" autocomplete="false">
                                </div>
                                {{-- <div class="form-check form-check-info text-left">
                                    <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault"
                                        checked>
                                    <label class="form-check-label" for="flexCheckDefault">
                                        Acepto los <a href="javascript:;" class="text-dark font-weight-bolder">Terminos
                                            y condiciones</a>
                                    </label>
                                </div> --}}
                                <div class="text-center">
                                    <button type="submit" class="btn  w-100 my-4 mb-2" style="background-color: #faca0c !important; color: rgb(0, 0, 0);">Registrarme</button>
                                </div>
                                <p class="text-sm mt-3 mb-0">¿Ya tienes una cuenta? <a href="{{url('login')}}"
