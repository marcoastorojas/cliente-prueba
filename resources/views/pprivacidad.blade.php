...
<head>
    ...
    <title>Politicas de privasidad</title>
</head>
<body>
...
<!-- wp:paragraph -->
<p>Cliente VIP - Sistema de lealtad para acumular puntos y ganar recompensas por tus consumos en tus negocios favoritos.</p>
<!-- /wp:paragraph -->
